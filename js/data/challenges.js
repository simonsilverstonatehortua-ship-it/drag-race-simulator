...
const DEFAULT_CHALLENGES = [
  { id: "DESIGN", label: "Design", category: "maxi", custom: false, stats: ["design"],
    description: "Confeccionar un look desde cero con un tiempo y presupuesto limitados." },
  { id: "ACTING", label: "Acting", category: "maxi", custom: false, stats: ["acting"],
    description: "Reto de interpretación dramática o comedia en un sketch/escena." },
  { id: "IMPROV", label: "Improv", category: "maxi", custom: false, stats: ["improv", "comedy"],
  ...
  { id: "BALL", label: "Ball", category: "runway", custom: false, stats: ["runway", "design", "makeup"],
  ...
  { id: "ADVERT", label: "Advert", category: "maxi", custom: false, stats: ["acting", "comedy"],
