...
const DEFAULT_STATUSES = [
  ...
  { id: "WIN_TIE", label: "Ganadora empatada (2+ ganan el reto)", type: "weekly", color: "#00008b",
    points: 10, countsForPoints: true, custom: false,
    description: "Empata en la puntuación más alta de la semana junto a otra(s) concursante(s): todas ganan el reto y se quedan con los 10 puntos de la victoria." },
  ...
  { id: "ELIM_MULTI", label: "Eliminada junto a otra(s) (doble/triple eliminación)", type: "weekly", color: "#8b0000",
    points: 0, countsForPoints: true, custom: false,
    description: "Empata en el fondo con otra(s) concursante(s) por el peor lip sync y es eliminada junto a ellas la misma semana." },
